...
const movieCenter = document.getElementById('movies');
const genresCenter = document.getElementById('genresCenter');
const actFilbtn = document.getElementById('action');
const adventFilbtn = document.getElementById('adventure');
const animatbtn = document.getElementById('animation');
const bioFilbtn = document.getElementById('biography');
const comFilbtn = document.getElementById('comedy');
const crimeFilbtn = document.getElementById('crime');
const dramaFilbtn = document.getElementById('drama');
const famFilbtn = document.getElementById('family');
const fantFilbtn = document.getElementById('fantasy');
const fnFilbtn = document.getElementById('film-Noir');
const hstFilbtn = document.getElementById('history');
const horFilbtn = document.getElementById('horror');
const musicalFilbtn = document.getElementById('musical');
const musFilbtn = document.getElementById('music');
const mysFilbtn = document.getElementById('mystery');
const romFilbtn = document.getElementById('romance');
const sciFilbtn = document.getElementById('sci-Fi');
const thrillFilbtn = document.getElementById('thriller');
const sptFilbtn = document.getElementById('sport');
const warFilbtn = document.getElementById('war');
const westFilbtn = document.getElementById('western');
...
function handleKeyPress(event) {
  ...
  if (event.key === 'Enter') {
    // console.dir(event);
    // //grab user input
    let search = userInputEle.value.toLowerCase()
    // takes input.value as arguement for the filter
    const filteredMovies = data.movies.filter(function (movie) {
      if (movie.title.toLowerCase() === search) {
        return movie;
      }
    });
    displayMovieItems(filteredMovies)
  };
...
window.addEventListener('DOMContentLoaded', function () {
  displayMovieItems(data.movies)
});

// inside of function makesure we are passing an arr
function displayMovieItems(dataItems) {
  // console.log(dataItems)
  let displayMovies = dataItems.map(function (movie) {
    return `
    <div id="movies" class="card">
    <article class="movie-items">
    <h2 class="title">${movie.title} </h2>
    <h3 class="year">Year: ${movie.year}</h3>
    <h3 class="runtime">Runtime:" ${movie.runtime}" </h3>
    <h3 class="genres"> ${movie.genres}</h3>
    <h3 class="director">Directed By: "${movie.director}"</h3>
    <h3 class="actors">Staring: "${movie.actors}"</h3>
    <h3 class="plot">Plot:" ${movie.plot}"</h3>
    </article>
    </div>`;
  });
  displayMovies = displayMovies.join('');
  movieCenter.innerHTML = displayMovies
}

// make a single listener that grabs event.target.textContent
// (the words in the button that was clicked)
// uses that as the arguement for the filter

menu.addEventListener('click', function (ev) {
  let genreFilter = ev.target.textContent
  const filteredMovies = data.movies.filter(function (movie) {
...
// // eventListener to filter action movies
// actFilbtn.addEventListener('click', function () {
//   const actionMovies = data.movies.filter(function (action) {
//     if (action.genres.includes('Action')) {
//       return action;
//     }
//   });
//   displayMovieItems(actionMovies)
// });

// // eventListener to filter adventure movies
// adventFilbtn.addEventListener('click', function () {
//   const adventureMovies = data.movies.filter(function (adventure) {
//     if (adventure.genres.includes('Adventure')) {
//       return adventure;
//     }
//   });
//   displayMovieItems(adventureMovies)
// });

// // eventListener to filter animation movies
// animatbtn.addEventListener('click', function () {
//   const animationMovies = data.movies.filter(function (animation) {
//     if (animation.genres.includes('Animation')) {
//       return animation
//     }
//   });
//   displayMovieItems(animationMovies)
// });
// // eventListener to filter biography movies
// actFilbtn.addEventListener('click', function () {
//   const actionMovies = data.movies.filter(function (action) {
//     if (action.genres.includes('Action')) {
//       return action
...
// });
// // eventListener to filter biography movies
// bioFilbtn.addEventListener('click', function () {
//   const bioMovies = data.movies.filter(function (biography) {
//     if (biography.genres.includes('Biography')) {
//       return biography
//     }
//   });
//   displayMovieItems(bioMovies)
// });
// // eventListener to filter comedy movies
// comFilbtn.addEventListener('click', function () {
//   const comedyMovies = data.movies.filter(function (comedy) {
//     if (comedy.genres.includes('Comedy')) {
//       return comedy
//     }
//   });
//   // console.log(comedy)
//   displayMovieItems(comedyMovies)
// });

// // eventListener to filter crime movies
// crimeFilbtn.addEventListener('click', function () {
//   const crimeMovies = data.movies.filter(function (crime) {
//     if (crime.genres.includes('Crime')) {
//       return crime
//     }
//   });
//   displayMovieItems(crimeMovies)
// });

// // eventListener to filter drama movies
// dramaFilbtn.addEventListener('click', function () {
//   const dramaMovies = data.movies.filter(function (drama) {
//     if (drama.genres.includes('Drama')) {
//       return drama
//     }
//   });
//   displayMovieItems(dramaMovies)
// });
// // eventListener to filter family movies
// famFilbtn.addEventListener('click', function () {
//   const familyMovies = data.movies.filter(function (family) {
//     if (family.genres.includes('Family')) {
//       return family
//     }
//   });
//   displayMovieItems(familyMovies)
// });

// // eventListener to filter fantasy movies
// fantFilbtn.addEventListener('click', function () {
//   const fantasyMovies = data.movies.filter(function (Fantasy) {
//     if (Fantasy.genres.includes('Fantasy')) {
//       return Fantasy
//     }
//   });
//   displayMovieItems(fantasyMovies)
// });
// // eventListener to filter film-noir movies
// fnFilbtn.addEventListener('click', function () {
//   const filmNoirMovies = data.movies.filter(function (filmNoir) {
//     if (filmNoir.genres.includes('Film-Noir')) {
//       return filmNoir
//     }
//   });
//   displayMovieItems(filmNoirMovies)
// });
// // eventListener to filter history movies
// hstFilbtn.addEventListener('click', function () {
//   const historyMovies = data.movies.filter(function (history) {
//     if (history.genres.includes('History')) {
//       return history
//     }
//   });
//   displayMovieItems(historyMovies)
// });
// // eventListener to filter horror movies
// horFilbtn.addEventListener('click', function () {
//   const horrorMovies = data.movies.filter(function (horror) {
//     if (horror.genres.includes('Horror')) {
//       return horror
//     }
//   });
//   displayMovieItems(horrorMovies)
// });

// // eventListener to filter muscical movies
// musicalFilbtn.addEventListener('click', function () {
//   const muscialMovies = data.movies.filter(function (muscical) {
//     if (muscical.genres.includes('Musical')) {
//       return muscical
//     }
//   });
//   displayMovieItems(muscialMovies)
// });

// // eventListener to filter music movies
// musFilbtn.addEventListener('click', function () {
//   const musicMovies = data.movies.filter(function (music) {
//     if (music.genres.includes('Music')) {
//       return music
//     }
//   });
//   displayMovieItems(musicMovies)
// });

// // eventListener to filter mystery movies
// mysFilbtn.addEventListener('click', function () {
//   const mysteryMovies = data.movies.filter(function (mystery) {
//     if (mystery.genres.includes('Mystery')) {
//       return mystery
//     }
//   });
//   displayMovieItems(mysteryMovies)
// });

// // eventListener to filter romance movies
// romFilbtn.addEventListener('click', function () {
//   const romanceMovies = data.movies.filter(function (romance) {
//     if (romance.genres.includes('Romance')) {
//       return romance
//     }
//   });
//   displayMovieItems(romanceMovies)
// });

// // eventListener to filter sci-fi movies
// sciFilbtn.addEventListener('click', function () {
//   const sciFiMovies = data.movies.filter(function (scifi) {
//     if (scifi.genres.includes('Sci-Fi')) {
//       return scifi
//     }
//   });
//   displayMovieItems(sciFiMovies)
// });

// // eventListener to filter thriller movies
// thrillFilbtn.addEventListener('click', function () {
//   const thrillerMovies = data.movies.filter(function (thriller) {
//     if (thriller.genres.includes('Thriller')) {
//       return thriller
//     }
//   });
//   displayMovieItems(thrillerMovies)
// });

// // eventListener to filter sport movies
// sptFilbtn.addEventListener('click', function () {
//   const sportMovies = data.movies.filter(function (sport) {
//     if (sport.genres.includes('Sport')) {
//       return sport
//     }
//   });
//   displayMovieItems(sportMovies)
// });
// // eventListener to filter war movies
// warFilbtn.addEventListener('click', function () {
//   const warMovies = data.movies.filter(function (war) {
//     if (war.genres.includes('War')) {
//       return war
//     }
//   });
//   displayMovieItems(warMovies)
// });

// // eventListener to filter western movies
// westFilbtn.addEventListener('click', function () {
//   const westernMovies = data.movies.filter(function (western) {
//     if (western.genres.includes('Western')) {
//       return western
//     }
//   });
//   displayMovieItems(westernMovies)
// });
