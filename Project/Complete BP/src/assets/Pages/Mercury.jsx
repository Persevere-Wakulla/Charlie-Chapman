...
const Mercury = ({ props }) => {
  ...
  return (
    <section className="sect">
      ...
      <Content index={myContent}  className="context" />
      ...
      >
        <button className="mercury">O1 OVERVIEW</button> <br />
        <button className="mercury">O2 INTERNAL STRUCTURE</button> <br />
        <button className="mercury">O3 SURFACE GEOLOGY</button>
      </div>
      </div></div>
